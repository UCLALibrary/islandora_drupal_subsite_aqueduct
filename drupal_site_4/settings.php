...
$databases = array (
  ...
  array (
    'default' =>
    array (
      'database' => 'drupal_site_4',
      'username' => trim(file_get_contents('/etc/drupal/default_db_user.txt')),
      'password' => trim(file_get_contents('/etc/drupal/default_db_password.txt')),
      'host' => 'localhost',
      'port' => '',
      'driver' => 'mysql',
      'prefix' => '',
 ...
 *
 */
$drupal_hash_salt = trim(file_get_contents('/etc/drupal/default_hash.txt'));
