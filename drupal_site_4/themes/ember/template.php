...
function ember_preprocess_html(&$vars) {
  ...
  drupal_add_css(path_to_theme() . '/styles/ie/ie.css', array('group' => CSS_THEME, 'browsers' => array('IE' => 'lte IE 9', '!IE' => FALSE), 'weight' => 999, 'preprocess' => FALSE));
